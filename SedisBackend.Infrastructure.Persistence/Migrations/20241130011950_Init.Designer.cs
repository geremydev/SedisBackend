            ...
            modelBuilder.Entity("SedisBackend.Core.Domain.Entities.Models.Service", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("609da5c7-b6c3-462e-af5e-c39ad3874cd7"),
                        ...
                        new
                        {
                            Id = new Guid("2280068e-12b0-44f8-a07a-bc0f8cee2d80"),
                        ...
                        new
                        {
                            Id = new Guid("31a45603-22c1-4694-8bae-f1321999b132"),
                        ...
                        new
                        {
                            Id = new Guid("967b98b0-4718-4da3-852f-e38b701d49dd"),
            ...
            modelBuilder.Entity("SedisBackend.Core.Domain.Entities.Relations.PatientMedicationPrescription", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("916e9144-b970-45f8-a253-b15d28c647b8"),
                            DoctorId = new Guid("b2f7d5b4-2f4d-4b2b-a292-1b9b65d5d6c0"),
                        ...
                        new
                        {
                            Id = new Guid("bd403def-cac2-42ed-890d-aa59adf196e0"),
                            DoctorId = new Guid("e9f7a7e1-f0d2-4f2c-bcb9-3e1a5a7a1e0b"),
                        ...
                        new
                        {
                            Id = new Guid("91be016e-e4cb-429f-a08d-2a694f5692e4"),
                            DoctorId = new Guid("b2f7d5b4-2f4d-4b2b-a292-1b9b65d5d6c0"),
                        ...
                        new
                        {
                            Id = new Guid("42ad98b9-5bce-43bc-bd62-0eb4ed744c38"),
                            DoctorId = new Guid("e9f7a7e1-f0d2-4f2c-bcb9-3e1a5a7a1e0b"),
                        ...
                        new
                        {
                            Id = new Guid("72125267-6107-4757-8b69-0b12e12cf125"),
                            DoctorId = new Guid("b2f7d5b4-2f4d-4b2b-a292-1b9b65d5d6c0"),
                        ...
                        new
                        {
                            Id = new Guid("591b3031-316a-4bbb-8ad6-d399e6953b96"),
                            DoctorId = new Guid("e9f7a7e1-f0d2-4f2c-bcb9-3e1a5a7a1e0b"),
            ...
            modelBuilder.Entity("SedisBackend.Core.Domain.Entities.Users.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CardId = "40211608647",
                            ConcurrencyStamp = "8ebe475f-b89e-44c5-b256-f27f4022bdef",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEAc5qLFWSOyUG9Kj2ouccscbWCGKDLQAB368v15cfCcZm1IeHMsjOj1Bfh6lYhkakQ==",
                            PhoneNumber = "809-962-2004",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "ad4822ec-c1b1-4ef3-ab29-22d13154b3d6",
                            Sex = "M",
                            Status = true,
                        ...
                        new
                        {
                            ...
                            Birthdate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CardId = "40323958764",
                            ConcurrencyStamp = "657eeb87-07bd-4118-9f1e-046e1f6d7cb5",
                            ...
                            LastName = "Ferrán",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAIAAYagAAAAEHwRaLnOCmIl5a18dZj9TODJ8tWOeTl/kH02jZ/7ajYdpnhc4q5f6BLdNgyX3zlS6w==",
                            PhoneNumber = "829-143-9811",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "1f9bae09-4c2b-483f-a766-36a4e665d37e",
                            Sex = "M",
                            Status = true,
                            TwoFactorEnabled = false,
                            UserName = "adminuser"
                        ...
                        new
                        {
                            ...
                            Birthdate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CardId = "40211608641",
                            ConcurrencyStamp = "8ad428d9-c293-4ade-8ff2-8836b6a9d6ca",
                            ...
                            LastName = "Abreu",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAIAAYagAAAAECBfogixIwKVpbWxiWL/bPLBFfRJdfSRi6vIi0uqnMmXEU7wOCbY0XYIYvXTBNvlrw==",
                            PhoneNumber = "829-163-9811",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "36702246-4072-4b3c-96de-64a677ad6eee",
                            Sex = "M",
                            Status = true,
                            TwoFactorEnabled = false,
                            UserName = "patient"
                        ...
                        new
                        {
                            ...
                            Birthdate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CardId = "40211608648",
                            ConcurrencyStamp = "8ed64f48-a5e9-4ac9-b4bb-b2250fa73d58",
                            ...
                            LastName = "Smith",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAIAAYagAAAAEMrGXgpyfWmcDTHoMRUw578JimJeCOK6ragd9HLdaQeTgLIos6ydDhgBiHr7AxY7QQ==",
                            PhoneNumber = "829-128-9811",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "298250b8-d818-49bd-a51c-edba0ae801eb",
                            Sex = "F",
                            Status = true,
                            TwoFactorEnabled = false,
                            UserName = "patient2"
                        ...
                        new
                        {
                            ...
                            CardId = "0987634321",
                            ConcurrencyStamp = "bdc1701b-009c-4beb-b8f4-e6204215ae24",
                            ...
                            LastName = "Martínez",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAIAAYagAAAAELdfs4pxJXChkp+UJhzNx+zHrgKjTMDlo3wPQEyzoCSMZIdZNuX7xBX82Q25yVeo0g==",
                            PhoneNumber = "829-123-9811",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "1ff8c6e2-57a4-459c-b477-de69a507d2d7",
                            Sex = "F",
                            Status = false,
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            ...
                            CardId = "40211608640",
                            ConcurrencyStamp = "8777171f-dcd9-4a9a-98f0-0fb53ab6e62b",
                            ...
                            LastName = "Polonio",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAIAAYagAAAAEH9wb5KFzfarTz8UzEJKTMPPCBZm+f6EIjGnfvPRKgzhEcgSK30LybLoyVu11hXhaQ==",
                            PhoneNumber = "829-123-9812",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "18bdbbb5-d5f8-44aa-91f5-77ad2b547d78",
                            Sex = "M",
                            Status = true,
                            TwoFactorEnabled = false,
                            UserName = "doctor"
                        ...
                        new
                        {
                            ...
                            CardId = "0987654321",
                            ConcurrencyStamp = "663d9b2c-47d1-4b50-8984-696e736adadf",
                            ...
                            LastName = "Vargas",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAIAAYagAAAAEL40Ao8xuoww/sXYXS+bRV7YglkjA5Z/zYe2ZOD+s4j/5Y7wtEiAmFda9sFX4Sgb1g==",
                            PhoneNumber = "829-123-9231",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "217b6329-d07e-4eba-a35f-5c85758afdf2",
                            Sex = "F",
                            Status = false,
                            TwoFactorEnabled = false,
                            UserName = "doctor2"
                        ...
                        new
                        {
                            ...
                            Birthdate = new DateTime(1995, 12, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CardId = "0587654321",
                            ConcurrencyStamp = "271097ca-99ca-4327-bac5-a11f18023162",
                            ...
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAIAAYagAAAAEF06YcTZpmrC/Udx83sMcvYX4B80YpIwBhkEUxZp3mmoHUZwxeOpskr1cqBFRJmoTA==",
                            PhoneNumber = "829-123-9312",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "d39f04dc-b328-4de1-9a92-0f392d4470be",
                            Sex = "M",
                            Status = false,
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            ...
                            CardId = "1122334455",
                            ConcurrencyStamp = "1f7f14f8-87e7-4396-8904-e81ce974453b",
                            ...
                            LastName = "Lopez",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAIAAYagAAAAEA2Y9JSgp4YJuWjf3k4o9jp67hJPX/ctp+AWAgR+MdpAaVPsXPI6Rd+VQ0kWpQh2qw==",
                            PhoneNumber = "809-987-6543",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "df2c5466-1059-491c-b899-2ee8e6949433",
                            Sex = "F",
                            Status = true,
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            ...
                            CardId = "3344556677",
                            ConcurrencyStamp = "1fca05f9-7045-4fea-9e0a-c42eeb443220",
                            ...
                            LastName = "Gonzalez",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAIAAYagAAAAEK2naswixwJ1JHXVr+ekd3LHXqqYc8i8r9bg88O7EYHO2DnhQz0Ml3wUCAYI3Ouyyw==",
                            PhoneNumber = "809-254-5678",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "517bbd70-a78e-4c16-ad7d-917e0a646600",
                            Sex = "M",
                            Status = true,
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            ...
                            CardId = "4455667788",
                            ConcurrencyStamp = "8f396860-fe87-4076-9801-e27bd5462fff",
                            ...
                            LastName = "Martinez",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAIAAYagAAAAENVwwMaMzqIdyaulo5pzJkMO4fBgib8p3pdfKdOk51BDbzZMfy+Ok58ZlBiyMar1wA==",
                            PhoneNumber = "809-876-5432",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "798a8dc0-6814-44b8-a4ad-0264010df466",
                            Sex = "F",
                            Status = true,
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            ...
                            CardId = "5566778899",
                            ConcurrencyStamp = "f3cac17a-20f0-4d32-877f-9772b6275024",
                            ...
                            LastName = "Santos",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAIAAYagAAAAEInPk7Rxrw8KTCoDT+i3WypQWhQKzs1FHYqulsi6BCMVEZNZ02/RmTUavmmkydj7mA==",
                            PhoneNumber = "809-321-9876",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "fa3fae20-8152-446a-8f9b-49f3548982a1",
                            Sex = "M",
                            Status = false,
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            ...
                            Birthdate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CardId = "12345678901",
                            ConcurrencyStamp = "8d3762ee-51fa-4cdb-9578-dece9b877fae",
                            ...
                            LastName = "Perez",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAIAAYagAAAAEJVz9+YZ5rqiNQtQQYappWHeb7eFh1E902ORBqM9rZoj8Ap4hSm1SZVcISOmnzkRmg==",
                            PhoneNumber = "809-123-4567",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "c7021e73-e609-4b17-bd94-e84a1539cac4",
                            Sex = "M",
                            Status = true,
                            TwoFactorEnabled = false,
                            UserName = "tech1user"
                        ...
                        new
                        {
                            ...
                            Birthdate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CardId = "98765432101",
                            ConcurrencyStamp = "ca13ab66-7727-4d41-add0-b9d4ceb55faf",
                            ...
                            LastName = "Lopez",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAIAAYagAAAAEGbwCi0+yTT9wB54vdPpufkvFKxd445TO/6hPllmR/ivUE+qHk4hmfFj3P4CCtGZJg==",
                            PhoneNumber = "809-234-4678",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "32a8b6bc-aaaf-4b62-b423-7ee5ec399df9",
                            Sex = "F",
                            Status = true,
                            TwoFactorEnabled = false,
                            UserName = "tech2user"
                        ...
                        new
                        {
                            ...
                            Birthdate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CardId = "13579246801",
                            ConcurrencyStamp = "1cbf2ed1-9488-4824-afec-c9aa4dc336ea",
                            ...
                            LastName = "Gomez",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAIAAYagAAAAEIS6wo6LAQDonN55N1KHIW9vRAiiP9RzuExrHJirNJp14d8h0QBnvrn4BR+8hZTXHw==",
                            PhoneNumber = "809-345-6789",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "77e4ba74-d070-48ff-a778-5c64a9625f16",
                            Sex = "M",
                            Status = true,
                            TwoFactorEnabled = false,
                            UserName = "tech3user"
            ...
            modelBuilder.Entity("SedisBackend.Core.Domain.Medical_History.MedicalConsultation.MedicalConsultation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 11, 30, 1, 19, 49, 65, DateTimeKind.Utc).AddTicks(7885),
                            ...
                            DoctorId = new Guid("b2f7d5b4-2f4d-4b2b-a292-1b9b65d5d6c0"),
                            LastModifiedDate = new DateTime(2024, 11, 30, 1, 19, 49, 65, DateTimeKind.Utc).AddTicks(7891),
                            PatientId = new Guid("c7f1d0d1-2b5f-4e77-a2a8-4b5d06d75950"),
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 11, 30, 1, 19, 49, 65, DateTimeKind.Utc).AddTicks(7898),
                            CurrentHistory = "Patient reports mild discomfort and fatigue in the eyes after working on a computer for extended periods.",
                            DoctorId = new Guid("b2f7d5b4-2f4d-4b2b-a292-1b9b65d5d6c0"),
                            LastModifiedDate = new DateTime(2024, 11, 30, 1, 19, 49, 65, DateTimeKind.Utc).AddTicks(7898),
                            PatientId = new Guid("e2a4d5b6-3c9a-47bc-8db1-cd327a2f92d6"),
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 11, 30, 1, 19, 49, 65, DateTimeKind.Utc).AddTicks(7904),
                            CurrentHistory = "Patient reports difficulty hearing in noisy environments. Speech development has been slower than expected.",
                            DoctorId = new Guid("e9f7a7e1-f0d2-4f2c-bcb9-3e1a5a7a1e0b"),
                            LastModifiedDate = new DateTime(2024, 11, 30, 1, 19, 49, 65, DateTimeKind.Utc).AddTicks(7904),
                            PatientId = new Guid("9c87b12f-d892-4f2b-8e2c-5347c8c1b056"),
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 11, 30, 1, 19, 49, 65, DateTimeKind.Utc).AddTicks(7909),
                            CurrentHistory = "Paciente reporta episodios de disnea y fatiga tras actividades leves.",
                            DoctorId = new Guid("b2f7d5b4-2f4d-4b2b-a292-1b9b65d5d6c0"),
                            LastModifiedDate = new DateTime(2024, 11, 30, 1, 19, 49, 65, DateTimeKind.Utc).AddTicks(7910),
                            PatientId = new Guid("d8e2f93f-3b9f-4b88-981f-56eaa8ddc3e9"),
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 11, 30, 1, 19, 49, 65, DateTimeKind.Utc).AddTicks(7917),
                            CurrentHistory = "Paciente refiere inicio agudo de dolor ocular intenso, acompañado de visión borrosa.",
                            DoctorId = new Guid("e9f7a7e1-f0d2-4f2c-bcb9-3e1a5a7a1e0b"),
                            LastModifiedDate = new DateTime(2024, 11, 30, 1, 19, 49, 65, DateTimeKind.Utc).AddTicks(7917),
                            PatientId = new Guid("ea48eb4c-01c4-44d2-a81f-fc9246d2ec20"),
