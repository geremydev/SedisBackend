...
namespace SedisBackend.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20241201202646_InitialMigration")]
            ...
            modelBuilder.Entity("SedisBackend.Core.Domain.Entities.Models.Service", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("5bb93898-9a10-45ca-ad1d-d2cb2e07343c"),
                        ...
                        new
                        {
                            Id = new Guid("a781c209-489b-4827-9c8a-4ea4b440887d"),
                        ...
                        new
                        {
                            Id = new Guid("8d83edd3-a410-4733-95a8-c36ca49cce99"),
                        ...
                        new
                        {
                            Id = new Guid("37ffb7b9-f17a-4603-a48d-bac8072199e0"),
            ...
            modelBuilder.Entity("SedisBackend.Core.Domain.Entities.Relations.PatientMedicationPrescription", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("c1fb3f1b-0331-44be-894b-7038406cc0e1"),
                            DoctorId = new Guid("b2f7d5b4-2f4d-4b2b-a292-1b9b65d5d6c0"),
                        ...
                        new
                        {
                            Id = new Guid("873e567d-26ef-4976-bb93-ff5f655264c3"),
                            DoctorId = new Guid("e9f7a7e1-f0d2-4f2c-bcb9-3e1a5a7a1e0b"),
                        ...
                        new
                        {
                            Id = new Guid("31309285-d897-40fb-902c-af677d1fa126"),
                            DoctorId = new Guid("b2f7d5b4-2f4d-4b2b-a292-1b9b65d5d6c0"),
                        ...
                        new
                        {
                            Id = new Guid("d2f5e044-b94e-464c-aaaa-bda7ee8bc1fc"),
                            DoctorId = new Guid("e9f7a7e1-f0d2-4f2c-bcb9-3e1a5a7a1e0b"),
                        ...
                        new
                        {
                            Id = new Guid("a5abc850-4b0c-4bad-8e8f-6a3feca29324"),
                            DoctorId = new Guid("b2f7d5b4-2f4d-4b2b-a292-1b9b65d5d6c0"),
                        ...
                        new
                        {
                            Id = new Guid("fd7b43c3-d86b-4696-bdc4-9292b17e863e"),
                            DoctorId = new Guid("e9f7a7e1-f0d2-4f2c-bcb9-3e1a5a7a1e0b"),
            ...
            modelBuilder.Entity("SedisBackend.Core.Domain.Entities.Users.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CardId = "40211608647",
                            ConcurrencyStamp = "d074e02d-2f44-4c70-a70f-2c8df67b7d66",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEBgLp+i1/HVb0SjNBdGfStbfjn+Zv+XVz520inJqyRLMCVCp+AbPMLxFYGZAOBXXBA==",
                            PhoneNumber = "809-962-2004",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "04fa9d03-8987-4113-a216-5d4a86a00d72",
                            Sex = "M",
                            Status = true,
                        ...
                        new
                        {
                            ...
                            Birthdate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CardId = "40208899928",
                            ConcurrencyStamp = "7705b71f-1f29-47df-971d-53726982fde2",
                            ...
                            LastName = "Ferrán",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAIAAYagAAAAEOFH0qVLqpkbrJkYREwzEwpoc280w28M1iwUqdE3UMmuL8V2ppxUqjDfcLeGf3EK1g==",
                            PhoneNumber = "829-143-9811",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "77905dde-1cb2-4135-8482-939e75c5c07b",
                            Sex = "M",
                            Status = true,
                            TwoFactorEnabled = false,
                            UserName = "adminuser"
                        ...
                        new
                        {
                            ...
                            Birthdate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CardId = "40211608641",
                            ConcurrencyStamp = "a9e48565-47ab-4981-8e33-9ee012347837",
                            ...
                            LastName = "Abreu",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAIAAYagAAAAEKCqqemcyRCSgBj1wBq4BZhfvR7RHy32iI+fDxBbwwEExM3myxyxjOY6is7w0WbtTA==",
                            PhoneNumber = "829-163-9811",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "b3935937-635d-4ad9-ae09-aae7bac49c5b",
                            Sex = "M",
                            Status = true,
                            TwoFactorEnabled = false,
                            UserName = "patient"
                        ...
                        new
                        {
                            ...
                            Birthdate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CardId = "40211608648",
                            ConcurrencyStamp = "d3fa2c56-dc5b-480a-861b-cd0d95ebb630",
                            ...
                            LastName = "Smith",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAIAAYagAAAAED95Q+ptJdeHR8+tuKIA0ttikq67TCn/HQL7WZCalCRUFILy4PgoBHE42vwlg4/J7w==",
                            PhoneNumber = "829-128-9811",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "f85c39db-286d-467e-a823-580e913949f6",
                            Sex = "F",
                            Status = true,
                            TwoFactorEnabled = false,
                            UserName = "patient2"
                        ...
                        new
                        {
                            ...
                            CardId = "0987634321",
                            ConcurrencyStamp = "55ba888e-9d2f-4f4a-9b2c-da6ab359ce58",
                            ...
                            LastName = "Martínez",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAIAAYagAAAAEEpRPP3UrbbGd06cLOlKRPGodtj7Fp1IvnZO6/1+G59kbXTfT1m8asMWy2fTyoY0pg==",
                            PhoneNumber = "829-123-9811",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "499cccdb-1e2d-4b69-b0b5-ea3fd1307108",
                            Sex = "F",
                            Status = false,
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            ...
                            CardId = "40211608640",
                            ConcurrencyStamp = "6e62f1c2-5aa9-4ec6-a56b-cf883d2431ed",
                            ...
                            LastName = "Polonio",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAIAAYagAAAAEPoMNtDzT7ZU39vnBJScStP/+pAPGiKsy4NenjaAoTWFuUM8jVf4Q8DbDXqJiUeHKA==",
                            PhoneNumber = "829-123-9812",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "d339cc82-7bcb-490a-b29b-2312ed3e7d18",
                            Sex = "M",
                            Status = true,
                            TwoFactorEnabled = false,
                            UserName = "doctor"
                        ...
                        new
                        {
                            ...
                            CardId = "0987654321",
                            ConcurrencyStamp = "ed78068d-1e30-4410-b5aa-170ca0daebed",
                            ...
                            LastName = "Vargas",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAIAAYagAAAAEMyIpNj9p/CeJ+qmWuWaSoWUUeQXqUvojXeBSg13D2lwTSOBziip7kTQLAD/WwPC5g==",
                            PhoneNumber = "829-123-9231",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "8b32763f-8702-4201-8cc9-05d0b8d9b98c",
                            Sex = "F",
                            Status = false,
                            TwoFactorEnabled = false,
                            UserName = "doctor2"
                        ...
                        new
                        {
                            ...
                            Birthdate = new DateTime(1995, 12, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CardId = "0587654321",
                            ConcurrencyStamp = "2a60be5c-92e9-41ac-ac25-badeb8b4789a",
                            ...
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAIAAYagAAAAEAwbl5ZJ185LuXuDlVnUw6DFjFWj7SmjhOjHGxB9/KH9yWSeChIaY4R95aaRyKbwrQ==",
                            PhoneNumber = "829-123-9312",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "3297b947-6a9f-4bc4-be5e-1f3f1814026f",
                            Sex = "M",
                            Status = false,
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            ...
                            CardId = "1122334455",
                            ConcurrencyStamp = "ffdabbb4-282e-4ad4-8e27-4da7e2d6f73a",
                            ...
                            LastName = "Lopez",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAIAAYagAAAAEFBDF474N78P7RNb2NmyfUox8LNUS6fEEDLVfGEWoGIkQXyoVBer3+kTPiWlhbqsug==",
                            PhoneNumber = "809-987-6543",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "0e7dff51-8023-4dc0-af97-509ac2aa8047",
                            Sex = "F",
                            Status = true,
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            ...
                            CardId = "3344556677",
                            ConcurrencyStamp = "be0f90b0-7fb8-434d-9876-78302898fff6",
                            ...
                            LastName = "Gonzalez",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAIAAYagAAAAEMbAEh0emv2EL4c6EIdYJaiMTyUB7inwQ4bUAasBVgK/WN0rUCKh2IQ4s9hQc39KhQ==",
                            PhoneNumber = "809-254-5678",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "dc5afa33-bb94-41cf-9734-7d5ed75aff6a",
                            Sex = "M",
                            Status = true,
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            ...
                            CardId = "4455667788",
                            ConcurrencyStamp = "1b6551a6-c526-45ce-af95-0060714f8273",
                            ...
                            LastName = "Martinez",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAIAAYagAAAAECdMRuG/Z1isOx4Of6TUa5AiwPXe19OufmWI/OEQ5I0/4TDE5uzY5rOheMF4zAI3Uw==",
                            PhoneNumber = "809-876-5432",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "2019d888-9f9c-4623-868e-c2e4f30e79db",
                            Sex = "F",
                            Status = true,
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            ...
                            CardId = "5566778899",
                            ConcurrencyStamp = "2116615d-4557-44bb-a6ec-412bb07a14e7",
                            ...
                            LastName = "Santos",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAIAAYagAAAAEIZuo6ZKaCJyrP95+cl9GIHjBAgD+gUBLm+2JSZdHU9T1d9ZqqXlp1B2uoWhhgqMhw==",
                            PhoneNumber = "809-321-9876",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "31f6de99-c20a-49a7-bbcb-c09d026fc11a",
                            Sex = "M",
                            Status = false,
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            ...
                            Birthdate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CardId = "12345678901",
                            ConcurrencyStamp = "c4e2a885-7607-41fe-bd84-88584d78f6a1",
                            ...
                            LastName = "Perez",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAIAAYagAAAAEK9VwGKA9hlAhU8r9OtrWGzelIlK5BP9Sl2LHVDU+GfBG6uVB0cOrj5aUO5mX+qVKQ==",
                            PhoneNumber = "809-123-4567",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "d47d333f-5204-411f-8d01-46545ae703d9",
                            Sex = "M",
                            Status = true,
                            TwoFactorEnabled = false,
                            UserName = "tech1user"
                        ...
                        new
                        {
                            ...
                            Birthdate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CardId = "98765432101",
                            ConcurrencyStamp = "214036b6-124e-432e-8d61-201bfe1e76f9",
                            ...
                            LastName = "Lopez",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAIAAYagAAAAELu7UuexOfJe3fWfN51RnmhBzs//j58X6KQjpyyqcoXAf40aBdm0VZ8eLsYs9ScApA==",
                            PhoneNumber = "809-234-4678",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "1bd0f677-1a40-4881-890e-1216032b900a",
                            Sex = "F",
                            Status = true,
                            TwoFactorEnabled = false,
                            UserName = "tech2user"
                        ...
                        new
                        {
                            ...
                            Birthdate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CardId = "13579246801",
                            ConcurrencyStamp = "06717aa6-23bd-48f0-b329-f296b567ccc1",
                            ...
                            LastName = "Gomez",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAIAAYagAAAAEA0tm7aIXAWi3ooaPbOfYVGvd0/DMaaV1tuRuUTx1SpTb4gSOrEyfuRI/raIdvYADw==",
                            PhoneNumber = "809-345-6789",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "50663280-5e76-4b5c-9f4d-e05e77aa1235",
                            Sex = "M",
                            Status = true,
                            TwoFactorEnabled = false,
                            UserName = "tech3user"
            ...
            modelBuilder.Entity("SedisBackend.Core.Domain.Medical_History.MedicalConsultation.MedicalConsultation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 12, 1, 20, 26, 45, 226, DateTimeKind.Utc).AddTicks(8046),
                            ...
                            DoctorId = new Guid("b2f7d5b4-2f4d-4b2b-a292-1b9b65d5d6c0"),
                            LastModifiedDate = new DateTime(2024, 12, 1, 20, 26, 45, 226, DateTimeKind.Utc).AddTicks(8052),
                            PatientId = new Guid("c7f1d0d1-2b5f-4e77-a2a8-4b5d06d75950"),
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 12, 1, 20, 26, 45, 226, DateTimeKind.Utc).AddTicks(8060),
                            CurrentHistory = "Patient reports mild discomfort and fatigue in the eyes after working on a computer for extended periods.",
                            DoctorId = new Guid("b2f7d5b4-2f4d-4b2b-a292-1b9b65d5d6c0"),
                            LastModifiedDate = new DateTime(2024, 12, 1, 20, 26, 45, 226, DateTimeKind.Utc).AddTicks(8060),
                            PatientId = new Guid("e2a4d5b6-3c9a-47bc-8db1-cd327a2f92d6"),
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 12, 1, 20, 26, 45, 226, DateTimeKind.Utc).AddTicks(8066),
                            CurrentHistory = "Patient reports difficulty hearing in noisy environments. Speech development has been slower than expected.",
                            DoctorId = new Guid("e9f7a7e1-f0d2-4f2c-bcb9-3e1a5a7a1e0b"),
                            LastModifiedDate = new DateTime(2024, 12, 1, 20, 26, 45, 226, DateTimeKind.Utc).AddTicks(8066),
                            PatientId = new Guid("9c87b12f-d892-4f2b-8e2c-5347c8c1b056"),
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 12, 1, 20, 26, 45, 226, DateTimeKind.Utc).AddTicks(8071),
                            CurrentHistory = "Paciente reporta episodios de disnea y fatiga tras actividades leves.",
                            DoctorId = new Guid("b2f7d5b4-2f4d-4b2b-a292-1b9b65d5d6c0"),
                            LastModifiedDate = new DateTime(2024, 12, 1, 20, 26, 45, 226, DateTimeKind.Utc).AddTicks(8071),
                            PatientId = new Guid("d8e2f93f-3b9f-4b88-981f-56eaa8ddc3e9"),
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 12, 1, 20, 26, 45, 226, DateTimeKind.Utc).AddTicks(8076),
                            CurrentHistory = "Paciente refiere inicio agudo de dolor ocular intenso, acompañado de visión borrosa.",
                            DoctorId = new Guid("e9f7a7e1-f0d2-4f2c-bcb9-3e1a5a7a1e0b"),
                            LastModifiedDate = new DateTime(2024, 12, 1, 20, 26, 45, 226, DateTimeKind.Utc).AddTicks(8076),
                            PatientId = new Guid("ea48eb4c-01c4-44d2-a81f-fc9246d2ec20"),
