...
namespace SedisBackend.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20241201204222_Fixed")]
    partial class Fixed
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SedisBackend.Core.Domain.Entities.Models.Service", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("1d767e91-107d-42bb-84f0-63660613cabe"),
                        ...
                        new
                        {
                            Id = new Guid("2ffd9f27-b924-4d0f-a7fc-c69f82675669"),
                        ...
                        new
                        {
                            Id = new Guid("226650b0-2aec-44fb-a869-2b5f484c1c30"),
                        ...
                        new
                        {
                            Id = new Guid("e17388ab-6cfb-4486-aacc-5f2625d3bc05"),
            ...
            modelBuilder.Entity("SedisBackend.Core.Domain.Entities.Relations.PatientMedicationPrescription", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e1cdf099-5ce7-48f1-96c0-5dd0a7285ad0"),
                            DoctorId = new Guid("b2f7d5b4-2f4d-4b2b-a292-1b9b65d5d6c0"),
                        ...
                        new
                        {
                            Id = new Guid("5220a1da-38a3-4fae-9b68-eed47ab4b776"),
                            DoctorId = new Guid("e9f7a7e1-f0d2-4f2c-bcb9-3e1a5a7a1e0b"),
                        ...
                        new
                        {
                            Id = new Guid("ccee6779-c36e-43b3-8ca6-32173bf0096e"),
                            DoctorId = new Guid("b2f7d5b4-2f4d-4b2b-a292-1b9b65d5d6c0"),
                        ...
                        new
                        {
                            Id = new Guid("f6026b2e-096b-4832-8da3-29fd7c5ffd4a"),
                            DoctorId = new Guid("e9f7a7e1-f0d2-4f2c-bcb9-3e1a5a7a1e0b"),
                        ...
                        new
                        {
                            Id = new Guid("aaa00b7f-2aa1-4be5-8868-edc3e84d9398"),
                            DoctorId = new Guid("b2f7d5b4-2f4d-4b2b-a292-1b9b65d5d6c0"),
                        ...
                        new
                        {
                            Id = new Guid("4e335fd0-3c5e-47dd-acdc-b5a29ddbe055"),
                            DoctorId = new Guid("e9f7a7e1-f0d2-4f2c-bcb9-3e1a5a7a1e0b"),
            ...
            modelBuilder.Entity("SedisBackend.Core.Domain.Entities.Users.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CardId = "40211608647",
                            ConcurrencyStamp = "0811b112-32c9-4662-9966-6c5fdeb3263e",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAENe/wOFL4uALf4gBTDc8T59JTUq3OkLGpYbvlg2Oq7bZcc92Hu3+V9z4htq+OT3EVA==",
                            PhoneNumber = "809-962-2004",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "fed4f401-03ed-41fa-a372-5995dc56e68f",
                            Sex = "M",
                            Status = true,
                        ...
                        new
                        {
                            ...
                            Birthdate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CardId = "40208899928",
                            ConcurrencyStamp = "3dc6ad07-21d6-4ed3-873e-03ab8d4e1c71",
                            ...
                            LastName = "Ferrán",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAIAAYagAAAAEDX65d3bJzbSXHtDrMsuNoK4r5EewxEooRQyYOnqEWxlCMYyOUgjo4IiO7I3D2mHuw==",
                            PhoneNumber = "829-143-9811",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "f607c870-167c-44aa-a151-7b8b0655c792",
                            Sex = "M",
                            Status = true,
                            TwoFactorEnabled = false,
                            UserName = "adminuser"
                        ...
                        new
                        {
                            ...
                            Birthdate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CardId = "40211608641",
                            ConcurrencyStamp = "26675ee2-71dd-4bb2-98f4-50ddc2843eda",
                            ...
                            LastName = "Abreu",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAIAAYagAAAAEB3LadzRZoBIC79L2pS/XW1LN3ibXFDwnZqPu0enPiXVuZjclEY6jjTypte+9LInyA==",
                            PhoneNumber = "829-163-9811",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "591ed0a8-90c1-4b60-a5d2-496a2bb36596",
                            Sex = "M",
                            Status = true,
                            TwoFactorEnabled = false,
                            UserName = "patient"
                        ...
                        new
                        {
                            ...
                            Birthdate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CardId = "40211608648",
                            ConcurrencyStamp = "503baad0-4a41-4ba4-9acc-373d9b3e06a2",
                            ...
                            LastName = "Smith",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAIAAYagAAAAEP3NW7czvpnZASXesQNLAM+IwX6KHObN4mHNBf6AcrZPsYkeVZZOwaUCAlbLLcmtaQ==",
                            PhoneNumber = "829-128-9811",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "bb2febcd-de16-43f4-81bd-d6daf43f6304",
                            Sex = "F",
                            Status = true,
                            TwoFactorEnabled = false,
                            UserName = "patient2"
                        ...
                        new
                        {
                            ...
                            CardId = "0987634321",
                            ConcurrencyStamp = "6b775eb7-5dfa-4e31-b260-0f8a21c19645",
                            ...
                            LastName = "Martínez",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAIAAYagAAAAELw9u8aPcjgAerXZk6D7NMKKHxS11yxAh5AxWM+SMLL/Jrs7SuBHsnlCd+gbnISgzw==",
                            PhoneNumber = "829-123-9811",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "61479421-56b6-4adb-881e-1c2dab19d31e",
                            Sex = "F",
                            Status = false,
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            ...
                            CardId = "40211608640",
                            ConcurrencyStamp = "0232a525-bb85-4926-91fa-cfdad4300932",
                            ...
                            LastName = "Polonio",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAIAAYagAAAAEGpvRlRoRjAc6tNwpcX0FPpC1FKYWmAen4UMsxY5uBGa4Yc3iha3v1wS2vO9x8EEUQ==",
                            PhoneNumber = "829-123-9812",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "d00518f8-c92b-45cb-98d7-17d906757e2c",
                            Sex = "M",
                            Status = true,
                            TwoFactorEnabled = false,
                            UserName = "doctor"
                        ...
                        new
                        {
                            ...
                            CardId = "0987654321",
                            ConcurrencyStamp = "d902a073-e417-4f21-95d8-b5ff7a2a969c",
                            ...
                            LastName = "Vargas",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAIAAYagAAAAEEGfmkfMxrZ+OB/aNJe5VXDlbWiP3G7Bl6ap8eHsAR59yADvmH9UmbdVew3BY4ZgcA==",
                            PhoneNumber = "829-123-9231",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "f831e3bc-8cde-4b21-819d-2a689d092cdb",
                            Sex = "F",
                            Status = false,
                            TwoFactorEnabled = false,
                            UserName = "doctor2"
                        ...
                        new
                        {
                            ...
                            Birthdate = new DateTime(1995, 12, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CardId = "0587654321",
                            ConcurrencyStamp = "8d263bc9-0a06-4b0f-a9c6-92c7b7b7e284",
                            ...
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAIAAYagAAAAELqKWP97XY76Wz9vEfso9ildwGuTvJG4qYKVsDfGLM2pv4K93nDH52ownw71z8aaSw==",
                            PhoneNumber = "829-123-9312",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "64c5c1b2-def3-4d90-bbb9-5846b1619483",
                            Sex = "M",
                            Status = false,
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            ...
                            CardId = "1122334455",
                            ConcurrencyStamp = "e5e8f5e3-7e46-430d-97c5-f2c2cd9a541a",
                            ...
                            LastName = "Lopez",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAIAAYagAAAAECib8fY82dCt6QNvuw0jtOiYNXlOBmGRlOqLA4e65vZ95l6CKVNcYQBTPCH7XD5vvQ==",
                            PhoneNumber = "809-987-6543",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "6e72471f-71ff-424b-b319-762841fecbf9",
                            Sex = "F",
                            Status = true,
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            ...
                            CardId = "3344556677",
                            ConcurrencyStamp = "a4a32c80-1496-477a-a6ac-03edd85d6c56",
                            ...
                            LastName = "Gonzalez",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAIAAYagAAAAEKwX9NMEwYgwaVEzfKyOp5WVqYJ8LCaa/0Tu3XE9dU2VKrd7SMxl5W8C9HPv/Hdflw==",
                            PhoneNumber = "809-254-5678",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "71e6ec8c-0fb0-4d18-a757-780f9d2939fb",
                            Sex = "M",
                            Status = true,
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            ...
                            CardId = "4455667788",
                            ConcurrencyStamp = "42aba1f8-8b9d-4706-972b-0cae02129fed",
                            ...
                            LastName = "Martinez",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAIAAYagAAAAEDX8gfbiJ9+ozcxCnGpbihUXHHIpbvlYc/Sgzl01u/wt4ZGBJvhM2uzm1YoVFuh5Fg==",
                            PhoneNumber = "809-876-5432",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "283bee48-4256-451c-85c9-835de9eb611c",
                            Sex = "F",
                            Status = true,
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            ...
                            CardId = "5566778899",
                            ConcurrencyStamp = "417d1031-431c-4376-8ed4-6306a752ed2c",
                            ...
                            LastName = "Santos",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAIAAYagAAAAELCfXBm8tr499pcowxHZ9bVpc0Cp39lp9jqnjWrOu/Ch0e+AmN2neAI5F3hiRXnnTw==",
                            PhoneNumber = "809-321-9876",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "1de7fe5b-a133-455a-a13c-6be8d9e29af6",
                            Sex = "M",
                            Status = false,
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            ...
                            Birthdate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CardId = "12345678901",
                            ConcurrencyStamp = "3c7f2171-7cd1-45c4-965c-c25b5bab8bce",
                            ...
                            LastName = "Perez",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAIAAYagAAAAEL/dzs3snmrUmdi6/yxM+dCFUyCWwsMLBvDsTDQU4l4MzK6Z2aKyPJ5pUs8CaLrCsg==",
                            PhoneNumber = "809-123-4567",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "d3d55208-e04f-4759-bb28-c8ffbc3ab89d",
                            Sex = "M",
                            Status = true,
                            TwoFactorEnabled = false,
                            UserName = "tech1user"
                        ...
                        new
                        {
                            ...
                            Birthdate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CardId = "98765432101",
                            ConcurrencyStamp = "b91c568e-6686-4c79-9e4c-905822ae3c4a",
                            ...
                            LastName = "Lopez",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAIAAYagAAAAEAtcIN+Ezp45zh9gDw41UUEz92pQBheVQtWVzxQnH6Z1SSj8P7SVaNRNIkUM11CP+w==",
                            PhoneNumber = "809-234-4678",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "e05c2315-7f48-40cd-9cf8-adb5910ac087",
                            Sex = "F",
                            Status = true,
                            TwoFactorEnabled = false,
                            UserName = "tech2user"
                        ...
                        new
                        {
                            ...
                            Birthdate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CardId = "13579246801",
                            ConcurrencyStamp = "3c558d5f-bcf4-4f99-bb2f-f710b61b34c3",
                            ...
                            LastName = "Gomez",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAIAAYagAAAAEEmjZEuD7tOSXJ45vstTDnORsoM4pQtduLOPvR3cFn3hM5W8v0gxNe87dE/w/QD0mQ==",
                            PhoneNumber = "809-345-6789",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "5ad2bfa6-c8fc-4d27-a77e-99131497068e",
                            Sex = "M",
                            Status = true,
                            TwoFactorEnabled = false,
                            UserName = "tech3user"
            ...
            modelBuilder.Entity("SedisBackend.Core.Domain.Medical_History.MedicalConsultation.MedicalConsultation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 12, 1, 20, 42, 21, 225, DateTimeKind.Utc).AddTicks(5966),
                            ...
                            DoctorId = new Guid("b2f7d5b4-2f4d-4b2b-a292-1b9b65d5d6c0"),
                            LastModifiedDate = new DateTime(2024, 12, 1, 20, 42, 21, 225, DateTimeKind.Utc).AddTicks(5978),
                            PatientId = new Guid("c7f1d0d1-2b5f-4e77-a2a8-4b5d06d75950"),
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 12, 1, 20, 42, 21, 225, DateTimeKind.Utc).AddTicks(5985),
                            CurrentHistory = "Patient reports mild discomfort and fatigue in the eyes after working on a computer for extended periods.",
                            DoctorId = new Guid("b2f7d5b4-2f4d-4b2b-a292-1b9b65d5d6c0"),
                            LastModifiedDate = new DateTime(2024, 12, 1, 20, 42, 21, 225, DateTimeKind.Utc).AddTicks(5986),
                            PatientId = new Guid("e2a4d5b6-3c9a-47bc-8db1-cd327a2f92d6"),
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 12, 1, 20, 42, 21, 225, DateTimeKind.Utc).AddTicks(5996),
                            CurrentHistory = "Patient reports difficulty hearing in noisy environments. Speech development has been slower than expected.",
                            DoctorId = new Guid("e9f7a7e1-f0d2-4f2c-bcb9-3e1a5a7a1e0b"),
                            LastModifiedDate = new DateTime(2024, 12, 1, 20, 42, 21, 225, DateTimeKind.Utc).AddTicks(5996),
                            PatientId = new Guid("9c87b12f-d892-4f2b-8e2c-5347c8c1b056"),
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 12, 1, 20, 42, 21, 225, DateTimeKind.Utc).AddTicks(6152),
                            CurrentHistory = "Paciente reporta episodios de disnea y fatiga tras actividades leves.",
                            DoctorId = new Guid("b2f7d5b4-2f4d-4b2b-a292-1b9b65d5d6c0"),
                            LastModifiedDate = new DateTime(2024, 12, 1, 20, 42, 21, 225, DateTimeKind.Utc).AddTicks(6153),
                            PatientId = new Guid("d8e2f93f-3b9f-4b88-981f-56eaa8ddc3e9"),
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 12, 1, 20, 42, 21, 225, DateTimeKind.Utc).AddTicks(6161),
                            CurrentHistory = "Paciente refiere inicio agudo de dolor ocular intenso, acompañado de visión borrosa.",
                            DoctorId = new Guid("e9f7a7e1-f0d2-4f2c-bcb9-3e1a5a7a1e0b"),
                            LastModifiedDate = new DateTime(2024, 12, 1, 20, 42, 21, 225, DateTimeKind.Utc).AddTicks(6162),
                            PatientId = new Guid("ea48eb4c-01c4-44d2-a81f-fc9246d2ec20"),
