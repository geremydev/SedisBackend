    ...
    public void Configure(EntityTypeBuilder<PatientLabTestPrescription> builder)
    {
        ...
        (
            new PatientLabTestPrescription
            {
                ...
                LabTestId = Guid.Parse("ab3f3482-973d-4912-8848-f82bbb107792"), // Test de biopsia de piel
            ...
            new PatientLabTestPrescription
            {
                ...
                DoctorId = Guid.Parse("b2f7d5b4-2f4d-4b2b-a292-1b9b65d5d6c0"), // Doctor asociado
                LabTestId = Guid.Parse("0c8b53f4-6962-4f89-807e-737900741e13"), // Radiografía de tórax
            ...
            new PatientLabTestPrescription
            {
                ...
                DoctorId = Guid.Parse("e9f7a7e1-f0d2-4f2c-bcb9-3e1a5a7a1e0b"), // Doctor asociado
