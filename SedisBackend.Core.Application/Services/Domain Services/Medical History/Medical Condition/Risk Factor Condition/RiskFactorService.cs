...
{
    public class RiskFactorService : GenericService<SaveRiskFactorDto, BaseRiskFactorDto, RiskFactor>, IRiskFactorService
    {
        public RiskFactorService(IGenericRepository<RiskFactor> repository, ILoggerManager logger, IMapper mapper) : base(repository, logger, mapper)
        {
        }
    }
}
