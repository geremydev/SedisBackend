...
namespace SedisBackend.Core.Application.Services.Domain_Services.Prescriptions
{
    ...
    {
        public MedicationPrescriptionService(IGenericRepository<MedicationPrescription> repository, ILoggerManager logger, IMapper mapper) : base(repository, logger, mapper)
        {
        }
    }
}
