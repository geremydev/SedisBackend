...
public sealed class PatchAppointmentHandler
    : IRequestHandler<PatchAppointmentCommand, (AppointmentForUpdateDto AppointmentToPatch, Appointment Appointment)>
{
    ...
    public async Task<(AppointmentForUpdateDto AppointmentToPatch, Appointment Appointment)> 
        Handle(PatchAppointmentCommand request, CancellationToken cancellationToken)
    {
